    ...
    <div className="max-w-5xl space-y-5">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                {priorityDisplay.length > 0 && (
                  <Button variant="ghost" size="sm" className="text-xs text-primary h-8 font-sans" onClick={() => navigate("/tarefas")}>
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" className="text-xs text-primary h-8 font-sans" onClick={() => navigate("/agenda")}>
      ...
      <motion.div custom={9} initial="hidden" animate="visible" variants={cardVariant}>
        <Card
          ...
          onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); navigate("/assistente"); } }}
        >
