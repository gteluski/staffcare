      ...
      <SidebarHeader className="px-3 py-4">
        {!collapsed ? (
          <div className="flex items-center justify-between">
            <img src="/staff-logo-light.png" alt="Staff care" className="h-7 object-contain opacity-90" />
            <button
                    ...
                    <SidebarMenuItem key={item.url}>
                      ...
                      >
                        <NavLink
                          ...
                          className="flex items-center gap-3 px-2.5 py-2 rounded-xl text-sm font-sans font-medium transition-all duration-200 hover:bg-sidebar-accent/50 animate-none"
