...
export default function AuthPage({ initialMode = "login" }: { initialMode?: "login" | "signup" }) {
  ...
  const handleResendConfirmation = async () => {
    if (!email) {
      toast.error("Digite o e-mail usado no cadastro.");
      return;
    }
    setLoading(true);
  ...
  if (signUpDone) {
    return (
      <div className="min-h-[100dvh] flex items-center justify-center px-4" style={{ backgroundColor: "#f4f2ef" }}>
        ...
        >
          <img src="/staff-logo-dark.png" alt="Staff care" className="h-14 mx-auto object-contain" />
  ...
  return (
    <div className="min-h-[100dvh] flex w-full" style={{ backgroundColor: "#f4f2ef" }}>
      <div className="flex-1 flex flex-col justify-center px-6 py-8 sm:px-12 lg:px-20 relative z-10">
        <div className="absolute top-6 left-6 sm:left-12 lg:left-20 flex items-center gap-4">
          <button onClick={() => router.push('/')} className="group flex items-center gap-2 text-xs font-sans text-muted-foreground hover:text-foreground transition-colors">
        ...
        >
          <img src="/staff-logo-dark.png" alt="Staff care" className="h-12 object-contain mb-10" />
      ...
      <div className="hidden lg:block lg:w-[48%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end h-full p-12">
          <motion.div
            ...
            className="space-y-5"
          >
            <img src="/staff-logo-light.png" alt="Staff care" className="h-10 object-contain opacity-80" />
